...
@WebServlet("/company/match/dibsdeleteok.do")
public class DibsDeleteOk extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String isdibs = req.getParameter("isdibs"); // 찜하기 페이지 인지?
		...
		int result = mdao.deleteDibs(pseq, tempSession);
